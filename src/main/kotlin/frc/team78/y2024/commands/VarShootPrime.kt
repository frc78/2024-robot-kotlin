...
class VarShootPrime : Command() {
    ...
    override fun execute() {
        ...
        var theta = calcTheta(GRAVITY, l, h, v)
    ...
    private fun calcTheta(g: Double, l: Double, h: Double, v: Double): Double {
        val sqrt: Double = v * v * v * v - (g * ((g * l * l) + (2 * h * v * v)))
    ...
    companion object {
        ...
        private val RPM_TO_MPS = Units.inchesToMeters(3.85) * PI / 60
